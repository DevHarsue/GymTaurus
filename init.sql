...
-- ============================================================
-- AUDITORÍA — schema audit, tabla audit_log, función y triggers
-- (mismo contenido que migrations/001-add-audit.sql)
-- ============================================================
...
-- ============================================================
-- RUTINAS DE EJERCICIO (mismo contenido que migrations/003-add-routines.sql)
-- Catalogo de ejercicios + plantillas (rutina -> dias -> ejercicios)
-- + asignacion por dia de semana + diario de entrenamiento.
-- ============================================================
...
-- ============================================================
-- RUTINAS v2 (mismo contenido que migrations/004-routines-v2.sql)
-- Tipos de medición + horario semanal por miembro.
-- ============================================================
